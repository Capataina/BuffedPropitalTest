...
class BuffedPropital {
    postDBLoad(container) {
        ...
        let regenStimDescription = "A 'super soldier serum' that infuses the blood with immense amounts of blood cells, providing temporary stimulating and empowering effects.";
        let regenStimTraderPrice = 175000;
        databaseServer.globals.config.Health.Effects.Stimulator.Buffs["buffedPropital_CombatStim"] = BuffedPropitalBuffs;
        const itemBuffedPropital = jsonUtil.clone(databaseServer.templates.items["5c0e534186f7747fa1419867"]);
        BuffedPropital.addStimData(itemBuffedPropital, regenStimId, "assets/content/weapons/usable_items/item_syringe/item_stimulator_sj12_tglabs_loot.bundle", "assets/content/weapons/usable_items/item_syringe/item_stimulator_sj12_tglabs_container.bundle", BuffedPropitalMaxUse, "buffedPropital_CombatStim");
        ...
        BuffedPropital.addLocales(locales, regenStimId, regenStimName, regenStimShortName, regenStimDescription);
        BuffedPropital.addHandbookItem(handbook, regenStimId, regenStimCategory, regenStimFleaPrice);
        BuffedPropital.addStimToTrader(therapist, regenStimId, regenStimTraderPrice, 100, 1);
        databaseServer.templates.items["619cbf7d23893217ec30b689"]._props.Grids[0]._props.filters[0].Filter.push(regenStimId);
    }
